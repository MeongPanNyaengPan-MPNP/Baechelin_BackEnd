...
public class LocationController {
    ...
    public StoreSingleResultDto.LatLong getGeoByAddress(@RequestParam String address) {
    ...
    public StoreResultDto.StoreResult getKeywordByGeoAndStoreName(@RequestParam BigDecimal lat, @RequestParam BigDecimal lng, String storeName){
    ...
    public List<StoreResultDto.StoreResult> getKeywordByGeoAndAddress(@RequestParam BigDecimal lat, @RequestParam BigDecimal lng, @RequestParam String address){
